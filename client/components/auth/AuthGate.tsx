  ...
  return (
    <Card className="border border-white/15 shadow-[0_24px_68px_rgba(15,23,42,0.55)] min-h-[380px] bg-white/12 text-gray-100 backdrop-blur-2xl">
      ...
      <CardContent className="space-y-4">
        <div className="relative">
          <label className="absolute -top-2.5 left-3 px-1 text-xs font-medium text-fuchsia-300 bg-transparent z-10">Email</label>
        ...
        <div className="relative">
          <label className="absolute -top-2.5 left-3 px-1 text-xs font-medium text-fuchsia-300 bg-transparent z-10">Mot de passe personnalisé</label>
