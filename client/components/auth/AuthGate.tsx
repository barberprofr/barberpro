    ...
    <div className="mx-auto max-w-sm">
      <div className="flex flex-col items-center justify-center mb-4">
        ...
        <h1 className="text-lg font-extrabold tracking-tight text-white">
          BarBerpro<svg viewBox="0 0 16 16" className="inline-block h-3 w-3 ml-0.5 -mt-1" aria-hidden><path d="M13.5 2L6 12l-3.5-3.5" fill="none" stroke="#dc2626" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
        </h1>
      </div>
