                ...
                {encaissementsOpen && (
                    ...
                    >
                        <motion.div
                            ...
                            className="relative w-[92%] max-w-md max-h-[80vh] overflow-hidden rounded-3xl bg-gradient-to-br from-slate-900/98 via-violet-900/40 to-slate-800/98 border border-violet-500/30 shadow-[0_25px_80px_rgba(0,0,0,0.6),0_0_40px_rgba(139,92,246,0.2)] backdrop-blur-xl mx-auto"
                        >
                            ...
                            <div className="p-2 sm:p-4 overflow-y-auto max-h-[calc(80vh-80px)]">
