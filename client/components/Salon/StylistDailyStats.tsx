        ...
        <div className="rounded-3xl border border-white/25 bg-slate-500/35 p-4 shadow-inner text-sm space-y-4 backdrop-blur-sm">
            <div className="space-y-3">
                <div className="flex items-center justify-between text-slate-100">
                    ...
                    <span className="text-5xl font-black tracking-wide text-fuchsia-300/80 [text-shadow:0_0_10px_rgba(232,121,249,0.6),0_0_20px_rgba(232,121,249,0.4)]">{eur.format(total?.amount || 0)}</span>
                </div>
