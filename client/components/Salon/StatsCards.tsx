...
function StylistCard({ s, config, onClick }: { s: any, config: any, onClick: () => void }) {
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.98 }}
      className="w-full rounded-2xl border border-white/25 bg-white/20 p-2 shadow-[0_18px_45px_rgba(15,23,42,0.15)] backdrop-blur-sm transition hover:border-white/40 hover:bg-white/25 text-left"
    >
