        ...
        <PopoverTrigger asChild>
          ...
          >
            ...
            <div className="relative flex items-center gap-4">
              <div className="relative flex items-center justify-center w-12 h-12 rounded-xl overflow-hidden bg-emerald-900/5 shadow-[0_6px_24px_rgba(16,185,129,0.5)]">
                <img src="/assets/barber-logo.png" alt="Coiffeurs" className="h-10 w-10 object-contain" />
              </div>
