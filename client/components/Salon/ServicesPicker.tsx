              ...
              {selectedPrestations.size > 0 && (
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-5xl font-black text-fuchsia-400/30 [text-shadow:0_0_8px_rgba(232,121,249,0.8),0_0_16px_rgba(232,121,249,0.5),0_0_24px_rgba(232,121,249,0.3)]">{total.toFixed(2)}€</span>
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
