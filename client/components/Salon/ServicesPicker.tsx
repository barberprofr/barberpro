                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <motion.button
                        ...
                        animate={isSelected ? { 
                          scale: [1, 1.2, 1],
                          boxShadow: ["0 0 0px rgba(52,211,153,0)", "0 0 40px rgba(52,211,153,0.9)", "0 0 25px rgba(52,211,153,0.6)"]
                        } : {}}
                        transition={{ duration: 0.4 }}
                        className={cn(
                          "relative flex h-10 w-10 items-center justify-center rounded-full flex-shrink-0 transition-all",
                          isSelected
                            ? "bg-gradient-to-br from-emerald-400 via-emerald-500 to-teal-600 shadow-[0_0_25px_rgba(52,211,153,0.6),inset_0_2px_4px_rgba(255,255,255,0.4),inset_0_-2px_4px_rgba(0,0,0,0.2)]"
                        ...
                        style={{
                          border: isSelected ? "3px solid rgba(167,243,208,0.6)" : "2px solid rgba(255,255,255,0.3)",
                        }}
                      >
                        {/* Outer glow ring */}
                        {isSelected && (
