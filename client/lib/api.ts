...
export function useUpdateConfig() {
  const qc = useQueryClient();
  return useMutation({
    mutationFn: async (input: Partial<{ loyaltyPercentDefault: number; paymentModes: MethodKey[]; commissionDefault: number; pointsRedeemDefault: number; salonName: string | null; showStylistPriority: boolean; hideTotalCA: boolean; currency: CurrencyCode }>) => {
