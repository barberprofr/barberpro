            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <button
                  ...
                  className="group relative flex flex-col items-center justify-center gap-1.5 rounded-2xl border-2 border-amber-400/60 bg-black/10 backdrop-blur-[2px] px-3 py-4 shadow-[0_8px_32px_rgba(0,0,0,0.2)] transition-all duration-300 hover:scale-[1.03] hover:border-amber-300/80 hover:shadow-[0_12px_40px_rgba(245,158,11,0.3)] active:scale-110 active:border-amber-200 active:shadow-[0_0_30px_rgba(245,158,11,0.6),0_0_60px_rgba(245,158,11,0.3)] active:brightness-125"
                >
