            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <button
                  ...
                  className="group relative flex flex-col items-center justify-center gap-1.5 rounded-2xl border-2 border-amber-400/60 bg-black/5 px-3 py-4 shadow-[0_8px_32px_rgba(0,0,0,0.15)] transition-all duration-300 hover:scale-[1.04] hover:border-amber-300/90 hover:shadow-[0_15px_50px_rgba(245,158,11,0.35)] active:scale-[1.15] active:rotate-1 active:border-amber-200 active:shadow-[0_0_40px_rgba(245,158,11,0.8),0_0_80px_rgba(245,158,11,0.5),0_0_120px_rgba(245,158,11,0.3)] active:brightness-150"
                >
